 ...
 */
class EDMBayiGoruntuleme extends Resources{
    void eDMBayiGoruntuleme(){
        ...
        sleep(1000)
        xpath(bayiGoruntuleme).click()
        //xpathload(bayiTipSec)
        idload(bayiGorSatKodu)
        id(jss(bayiGorSatKodu)).sendKeys("111111")
        xpathload(bayiEDM)
        sleep(1000)
        id(jss(bayiTicUnvan)).sendKeys("EDM Testttt")
        id(jss(bayiTabAdi)).sendKeys("EDM Testttt2")
        idload(bolge)
        //xpathload(bolgeSec)
